...
- Name: admin/TC-DASH-dashboard.spec.ts >> Admin Dashboard — GET /api/admin/dashboard >> TC-DASH-001 | dashboard returns required metric fields with correct types
- Location: admin/TC-DASH-dashboard.spec.ts:18:7
