...
- Name: products/TC-PROD-admin-crud.spec.ts >> TC-PROD-001 | create product with valid payload → 201, all fields persisted correctly
- Location: products/TC-PROD-admin-crud.spec.ts:37:5
