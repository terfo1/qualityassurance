...
- Name: cart/TC-CART-add-item.spec.ts >> TC-CART-001 | add valid in-stock product → 200, item appears in cart with correct line_total
- Location: cart/TC-CART-add-item.spec.ts:35:5

# Error details

```
Error: Registration failed: HTTP 500 — Internal Server Error
```
