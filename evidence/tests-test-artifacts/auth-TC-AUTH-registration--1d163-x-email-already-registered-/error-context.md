...
- Name: auth/TC-AUTH-registration.spec.ts >> Registration — POST /api/auth/register >> TC-AUTH-003 | duplicate email → 4xx (email already registered)
- Location: auth/TC-AUTH-registration.spec.ts:48:7
