...
- Name: auth/TC-AUTH-registration.spec.ts >> Registration — POST /api/auth/register >> TC-AUTH-001 | valid payload → 201 with user object (no password exposed)
- Location: auth/TC-AUTH-registration.spec.ts:16:7
...
Expected: "qa_17752306065271@test.novacart.local"
Received: undefined
```
