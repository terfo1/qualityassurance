...
- Name: auth/TC-AUTH-login.spec.ts >> Login — POST /api/auth/login >> TC-LOGIN-004 | non-existent email → 401 (must not reveal whether email exists)
- Location: auth/TC-AUTH-login.spec.ts:58:7
